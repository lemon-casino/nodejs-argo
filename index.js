...
const APP_VERSION = 'lemon';                      // Docker 镜像版本号（供 GitHub Actions 读取）
const UUID = (process.env.UUID && process.env.UUID.trim()) ? process.env.UUID.trim() : generateUUID(); // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
